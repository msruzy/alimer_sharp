...
namespace Vortice.Graphics
{
    ...
    /// </summary>
    public readonly struct RenderPassDepthStencilAttachment : IEquatable<RenderPassDepthStencilAttachment>
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="RenderPassDepthStencilAttachment"/> struct.
        /// </summary>
        ...
        /// <summary>
        /// Compares two <see cref="RenderPassDepthStencilAttachment"/> objects for equality.
        /// </summary>
        /// <param name="left">
        /// The <see cref="RenderPassDepthStencilAttachment"/> on the left side of the operand.
        /// </param>
        /// <param name="right">
        /// The <see cref="RenderPassDepthStencilAttachment"/> on the right side of the operand.
        /// </param>
        /// <returns>
        /// True if the <paramref name="left"/> parameter is equal to the <paramref name="right"/> parameter; otherwise, false.
        /// </returns>
        public static bool operator ==(RenderPassDepthStencilAttachment left, RenderPassDepthStencilAttachment right)
        {
        ...
        /// Compares two <see cref="RenderPassDepthStencilAttachment"/> objects for equality.
        /// </summary>
        /// <param name="left">The <see cref="RenderPassDepthStencilAttachment"/> on the left side of the operand.</param>
        /// <param name="right">The <see cref="RenderPassDepthStencilAttachment"/> on the right side of the operand.</param>
        /// <returns>
        ...
        /// <inheritdoc />
        public bool Equals(RenderPassDepthStencilAttachment other) =>
        ...
        {
            return obj is RenderPassDepthStencilAttachment other && this.Equals(other);
        }
